import { EllipsisLocation } from "./ellipsis-location";

export class StringExtensions {
    ellide(original: string, finalLength: number, ellipsisLocation: EllipsisLocation = EllipsisLocation.end, ellipsis: string = '...'): string {
...
export const SE = new StringExtensions();